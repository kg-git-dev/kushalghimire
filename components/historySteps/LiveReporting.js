              ...
              <div className="content">
                ...
                <div className='experiment'>
                  <div className="extra text">
                    ...
                    <br />In late 2016, our private lesson iOS application assignmate was cited to violate "the business model rule" and declined ios app store entry. Assignmate used Stripe and included a mechanism for refund. Refunding while using Apple's payment system was impossible. Apple dictactes 30% flat cut from initial purchase which in non refundible to the publisher. In order to issue a refund, we had to take a 30% flat loss. 
                    <br /><br />
